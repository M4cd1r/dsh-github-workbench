...
function WorkbenchApp({ sessionId, visible, seedUrl }) {
  ...
  const header = /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-header", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-hbtn", title: t("mount.settingsAutoRefresh"), onClick: () => {
      setSetPop((v) => !v);
      setRepoPop(false);
  ...
  const body = !ref ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SetupCard, { detecting, onSubmit: applyRepo, error }) : /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-tabs", children: SUBTABS.map((t2) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("button", { className: `gw-tab ${subtab === t2.id ? "on" : ""}`, onClick: () => switchTab(t2.id), children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(GwIcon, { name: t2.icon, size: 13 }),
      t2.label,
      counts[t2.id] !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "gw-count", children: counts[t2.id] })
    ] }, t2.id)) }),
...
function SetupCard(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-empty", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { maxWidth: 340, width: "100%" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { marginBottom: 10, lineHeight: 1.7 }, children: props.detecting ? t("loadingTree") : "owner/repo or paste a GitHub URL" }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("form", { className: "gw-formrow", onSubmit: (e) => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-btn primary", type: "submit", children: t("confirm.yes") })
    ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { ref: wrap, style: { position: "absolute", inset: 0, zIndex: 50 }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop left", style: { top: 44, position: "absolute", width: "min(380px, calc(100% - 20px))" }, children: !manage ? /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("form", { className: "gw-formrow", onSubmit: (e) => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        ...
        {
          className: "gw-input",
          placeholder: props.hasToken ? "Filter repos / Search public / owner/repo" : "owner/repo or paste a GitHub URL",
          value,
          onChange: (e) => setValue(e.target.value),
          autoFocus: true
        }
    ...
    props.recent.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-title", style: { paddingTop: 8 }, children: "Recent" }),
      recent.map((full) => {
        const owner = full.split("/")[0];
    ...
    props.hasToken && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      ...
      hidden.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-pop-hint", style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-btn", style: { padding: "1px 8px" }, onClick: () => setManage(true), children: "Manage" })
      ] })
    ] }),
    loadErr && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-errbox", children: loadErr }),
    !props.hasToken && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: "Enter a PAT in Settings to list your repos." }),
    (q.length >= 3 || searching) && !manage && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      ...
      !searching && pub && pub.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: "No results." }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: "Press Enter to parse as owner/repo." })
    ] })
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { maxHeight: 240, overflow: "auto" }, children: [
      hidden.map((full) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("button", { className: "gw-pop-item", onClick: () => {
        ...
        full,
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "gw-pop-cur", children: "Restore" })
      ] }, full)),
      hidden.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: "Empty." })
    ] }),
...
function SettingsPopover(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { ref: wrap, style: { position: "absolute", inset: 0, zIndex: 50 }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-pop right", style: { top: 44, position: "absolute" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-title", children: "GitHub Personal Access Token" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { children: "Font size" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
        "select",
        {
          className: "gw-input",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "dsh", children: "Follow DSH sidebar (12px)" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-pop-hint", children: [
      "Fine-grained token scopes: Contents(R), Issues(RW), Pull requests(RW), Actions(RW); Classic token: use ",
