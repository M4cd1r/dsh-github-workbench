...
var zh = {
  ...
  "workbench.selectRepository": "\u9009\u62E9\u4ED3\u5E93",
  "workbench.branchSelector": "\u9009\u62E9\u5206\u652F",
  "workbench.settings": "\u8BBE\u7F6E",
  "workbench.loadRepository": "\u52A0\u8F7D\u4ED3\u5E93",
  "workbench.switchRepository": "\u5207\u6362\u4ED3\u5E93",
  "workbench.private": "\u79C1\u6709",
  "workbench.authPat": "PAT",
  "workbench.authAnonymous": "\u533F\u540D",
  "workbench.api": "api.github.com \xB7 REST v3",
  "workbench.footerStatus": "core \u5269\u4F59 {remaining} \xB7 {auth} \xB7 \u5BB9\u5668 {width}px",
  "workbench.repoPrompt": "owner/repo \u6216\u7C98\u8D34 GitHub URL",
  "workbench.repoFilterPlaceholder": "\u7B5B\u9009\u4ED3\u5E93 / \u641C\u7D22\u516C\u5F00\u4ED3\u5E93 / owner/repo",
  "workbench.recent": "\u6700\u8FD1\u4F7F\u7528",
  "workbench.remove": "\u79FB\u9664",
  "workbench.repos": "\u4ED3\u5E93 \xB7 {count}/{total}",
  "workbench.removeFromList": "\u4ECE\u5217\u8868\u79FB\u9664",
  "workbench.hidden": "\u5DF2\u9690\u85CF\uFF1A{count}",
  "workbench.manage": "\u7BA1\u7406",
  "workbench.patHint": "\u5728\u8BBE\u7F6E\u4E2D\u586B\u5165 PAT \u4EE5\u5217\u51FA\u4F60\u7684\u4ED3\u5E93\u3002",
  "workbench.search": "\u641C\u7D22\u201C{query}\u201D",
  "workbench.noResults": "\u6CA1\u6709\u7ED3\u679C\u3002",
  "workbench.pressEnter": "\u6309 Enter \u5C06\u8F93\u5165\u89E3\u6790\u4E3A owner/repo\u3002",
  "workbench.hiddenRepos": "\u9690\u85CF\u7684\u4ED3\u5E93\uFF08{count}\uFF09",
  "workbench.restore": "\u6062\u590D",
  "workbench.empty": "\u7A7A\u3002",
  "workbench.patTitle": "GitHub Personal Access Token",
  "workbench.autoRefreshOff": "{label}\uFF080 = \u5173\u95ED\uFF09",
  "workbench.fontSize": "\u5B57\u4F53\u5927\u5C0F",
  "workbench.followSidebar": "\u8DDF\u968F DSH \u4FA7\u8FB9\u680F\uFF0812px\uFF09",
  "workbench.tokenScopes": "\u7EC6\u7C92\u5EA6 Token \u6743\u9650\uFF1AContents(R)\u3001Issues(RW)\u3001Pull requests(RW)\u3001Actions(RW)\uFF1B\u7ECF\u5178 Token \u4F7F\u7528 <code>repo</code>\u3002\u4EC5\u5B58\u50A8\u5728\u672C\u5730\u3002",
  // Time formatting
  "time.justNow": "\u521A\u521A",
  ...
  "error.rejectedNoDetail": "\u8BF7\u6C42\u88AB GitHub \u62D2\u7EDD(HTTP 422)\uFF1AGitHub \u672A\u63D0\u4F9B\u8BE6\u60C5\u3002",
  ...
  "actions.duration": " \xB7 \u7528\u65F6 {duration}",
  "actions.queued": "\u6392\u961F\u4E2D",
  "actions.running": "\u8FD0\u884C\u4E2D",
  ...
  // Pull requests
  "pulls.filterOpen": "\u5F00\u653E",
  "pulls.filterClosed": "\u5DF2\u5173\u95ED",
  "pulls.filterMerged": "\u5DF2\u5408\u5E76",
  "pulls.new": "\u65B0\u5EFA PR",
  "pulls.emptyOpen": "\u6CA1\u6709\u6253\u5F00\u7684 Pull Request\u3002",
  "pulls.emptyClosed": "\u6CA1\u6709\u5DF2\u5173\u95ED(\u672A\u5408\u5E76)\u7684 Pull Request\u3002",
  "pulls.emptyMerged": "\u6CA1\u6709\u5DF2\u5408\u5E76\u7684 Pull Request\u3002",
  "pulls.updated": "\u66F4\u65B0",
  "pulls.draft": "\u8349\u7A3F",
  "pulls.newTitle": "\u65B0\u5EFA Pull Request",
  "pulls.head": "head(\u6E90\u5206\u652F)",
  "pulls.base": "base(\u76EE\u6807\u5206\u652F)",
  "pulls.create": "\u521B\u5EFA PR",
  "pulls.created": "PR #{number} \u5DF2\u521B\u5EFA",
  "pulls.mergeConfirm": "\u4EE5 {method} \u5408\u5E76 #{number}?",
  "pulls.mergeBody": "{head} \u2192 {base}\n\u5C06\u6309 GitHub \u7684\u8BE5\u65B9\u5F0F\u4EA7\u751F\u63D0\u4EA4,\u5408\u5E76\u540E\u901A\u5E38\u81EA\u52A8\u5220\u9664\u6E90\u5206\u652F\u3002",
  "pulls.merged": "PR #{number} \u5DF2\u5408\u5E76({method})",
  "pulls.closeConfirm": "\u5173\u95ED PR #{number}?",
  "pulls.closed": "PR #{number} \u5DF2\u5173\u95ED",
  "pulls.reopened": "PR #{number} \u5DF2\u91CD\u65B0\u6253\u5F00",
  "pulls.createdAt": "\u521B\u5EFA\u4E8E",
  "pulls.files": "{count} \u4E2A\u6587\u4EF6",
  "pulls.checksFailed": "\u5931\u8D25 {count}",
  "pulls.checksPending": "\u8FDB\u884C\u4E2D",
  "pulls.checksPassed": "\u901A\u8FC7 {count}",
  "pulls.mergeConflict": "\u5B58\u5728\u51B2\u7A81,\u65E0\u6CD5\u5408\u5E76",
  "pulls.moreChecks": "\u2026 \u5176\u4F59 {count} \u9879\u89C1 GitHub",
  "pulls.checkFallback": "check",
  "pulls.noDescription": "(\u65E0\u63CF\u8FF0)",
  "pulls.close": "\u5173\u95ED PR",
  "pulls.reopen": "\u91CD\u65B0\u6253\u5F00",
  "pulls.mergeMethod.merge": "Merge",
  "pulls.mergeMethod.squash": "Squash and merge",
  "pulls.mergeMethod.rebase": "Rebase and merge",
  "pulls.mergeMethod.mergeCommit": "Create a merge commit",
  // Comments
  ...
  // Inbox
  "inbox.title": "\u6536\u4EF6\u7BB1",
  "inbox.unread": " \xB7 {count} \u672A\u8BFB",
  "inbox.unreadCount": "{count} \u672A\u8BFB",
  "inbox.fresh": "\u65B0 {kind} \xB7 {repo} {id}",
  "inbox.kindIssue": "Issue",
  "inbox.kindPr": "Pull request",
  "inbox.kindActions": "Workflow run",
  "inbox.runNumber": "\u8FD0\u884C #{number}",
  "inbox.originalRepo": "\u539F\u4ED3\u5E93",
  ...
  "mount.collapseWorkbench": "\u6536\u8D77 GitHub \u5DE5\u4F5C\u53F0",
  "mount.expandWorkbench": "\u5C55\u5F00 GitHub \u5DE5\u4F5C\u53F0"
};
...
var en = {
  ...
  "workbench.selectRepository": "Select repository",
  "workbench.branchSelector": "Select branch",
  "workbench.settings": "Settings",
  "workbench.loadRepository": "Load repository",
  "workbench.switchRepository": "Switch repository",
  "workbench.private": "private",
  "workbench.authPat": "PAT",
  "workbench.authAnonymous": "Anonymous",
  "workbench.api": "api.github.com \xB7 REST v3",
  "workbench.footerStatus": "core: {remaining} remaining \xB7 {auth} \xB7 pane {width}px",
  "workbench.repoPrompt": "owner/repo or paste a GitHub URL",
  "workbench.repoFilterPlaceholder": "Filter repos / Search public / owner/repo",
  "workbench.recent": "Recent",
  "workbench.remove": "Remove",
  "workbench.repos": "Repos \xB7 {count}/{total}",
  "workbench.removeFromList": "Remove from list",
  "workbench.hidden": "Hidden: {count}",
  "workbench.manage": "Manage",
  "workbench.patHint": "Enter a PAT in Settings to list your repos.",
  "workbench.search": 'Search "{query}"',
  "workbench.noResults": "No results.",
  "workbench.pressEnter": "Press Enter to parse as owner/repo.",
  "workbench.hiddenRepos": "Hidden repos ({count})",
  "workbench.restore": "Restore",
  "workbench.empty": "Empty.",
  "workbench.patTitle": "GitHub Personal Access Token",
  "workbench.autoRefreshOff": "{label} (0 = off)",
  "workbench.fontSize": "Font size",
  "workbench.followSidebar": "Follow DSH sidebar (12px)",
  "workbench.tokenScopes": "Fine-grained token scopes: Contents(R), Issues(RW), Pull requests(RW), Actions(RW); classic tokens use <code>repo</code>. Stored locally only.",
  // Time formatting
  ...
  "error.rejectedNoDetail": "Request rejected by GitHub (HTTP 422): GitHub provided no details.",
  ...
  "actions.active": " \xB7 {count} in progress",
  ...
  // Pull requests
  "pulls.filterOpen": "Open",
  "pulls.filterClosed": "Closed",
  "pulls.filterMerged": "Merged",
  "pulls.new": "New PR",
  "pulls.emptyOpen": "No open Pull requests.",
  "pulls.emptyClosed": "No closed (unmerged) Pull requests.",
  "pulls.emptyMerged": "No merged Pull requests.",
  "pulls.updated": "Updated",
  "pulls.draft": "Draft",
  "pulls.newTitle": "New Pull Request",
  "pulls.head": "head (source branch)",
  "pulls.base": "base (target branch)",
  "pulls.create": "Create PR",
  "pulls.created": "PR #{number} created",
  "pulls.mergeConfirm": "Merge #{number} with {method}?",
  "pulls.mergeBody": "{head} \u2192 {base}\nGitHub will create the commit using this method and usually delete the source branch after merging.",
  "pulls.merged": "PR #{number} merged ({method})",
  "pulls.closeConfirm": "Close PR #{number}?",
  "pulls.closed": "PR #{number} closed",
  "pulls.reopened": "PR #{number} reopened",
  "pulls.createdAt": "opened",
  "pulls.files": "{count} files",
  "pulls.checksFailed": "{count} failed",
  "pulls.checksPending": "in progress",
  "pulls.checksPassed": "{count} passed",
  "pulls.mergeConflict": "Conflicts prevent merging",
  "pulls.moreChecks": "\u2026 {count} more on GitHub",
  "pulls.checkFallback": "check",
  "pulls.noDescription": "(no description)",
  "pulls.close": "Close PR",
  "pulls.reopen": "Reopen",
  "pulls.mergeMethod.merge": "Merge",
  "pulls.mergeMethod.squash": "Squash and merge",
  "pulls.mergeMethod.rebase": "Rebase and merge",
  ...
  // Inbox
  "inbox.title": "Inbox",
  "inbox.unread": " \xB7 {count} unread",
  "inbox.unreadCount": "{count} unread",
  "inbox.fresh": "New {kind} \xB7 {repo} {id}",
  "inbox.kindIssue": "Issue",
  "inbox.kindPr": "Pull request",
  "inbox.kindActions": "Workflow run",
  "inbox.runNumber": "run #{number}",
  "inbox.originalRepo": "original repository",
  ...
  "mount.collapseWorkbench": "Collapse GitHub Workbench",
  "mount.expandWorkbench": "Expand GitHub Workbench"
};
...
async function getTree(ref, branch) {
  ...
  return { items: r.tree.filter((t2) => t2.type === "blob" || t2.type === "tree"), truncated: r.truncated };
}
var MAX_INLINE = 9e5;
var MAX_LINES = 3e3;
...
function ErrorBox(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "gw-errbox", children: [
    props.msg,
    props.onRetry && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: 8 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "gw-btn", onClick: props.onRetry, children: t("retry") }) })
  ] });
}
...
function CodeView({ ghRef, branch }) {
  ...
  if (!items) return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Loading, { label: t("loadingTree") });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "gw-codepane" + (treeOpen ? " tree-open" : ""), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "gw-tree", children: [
      truncated && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "gw-pop-hint", style: { padding: "2px 6px 8px" }, children: t("tree.truncated") }),
      ...
      nodes.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "gw-empty", children: t("empty.repo") })
    ] }),
    ...
    ) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "gw-empty", children: t("empty.selectFile") }) })
  ] });
}
...
function FilePane(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "gw-crumb", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: "gw-hbtn", title: t("tree.closeFile"), onClick: props.onClose, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(GwIcon, { name: "x-circle", size: 13 }) })
    ] }),
    error && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ErrorBox, { msg: error }),
    !error && !data && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Loading, { label: t("loadingFile") }),
    data?.kind === "text" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "gw-code", children: [
      ...
      data.truncatedLines && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "gw-pop-hint", style: { padding: "6px 12px" }, children: t("file.truncated") })
    ] }),
    data && data.kind !== "text" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "gw-empty", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("a", { className: "gw-link", href: data.htmlUrl, target: "_blank", rel: "noreferrer", children: t("file.openOnGitHub") })
    ] }) })
  ] });
}
...
function CommentsBlock(props) {
  ...
  async function del(c) {
    if (!await ui.confirm({
      ...
      confirmText: t("comments.deleteText"),
      danger: true
    })) return;
    try {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "gw-muted", style: { fontSize: 11, marginBottom: 2 }, children: t("comments.count", { count: props.comments.length, extra: props.nextUrl ? "+" : "" }) }),
    ...
    props.nextUrl && props.onLoadMore && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "gw-more", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "gw-btn", disabled: props.loadingMore, onClick: props.onLoadMore, children: props.loadingMore ? t("loading") : t("loadMoreComments") }) })
  ] });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "gw-comment", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "gw-comment-head", children: [
      ...
      props.mine && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { marginLeft: "auto", display: "inline-flex", gap: 4 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "gw-hbtn", title: t("comments.editTitle"), onClick: () => setEditing(true), children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(GwIcon, { name: "pencil", size: 12 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "gw-hbtn", title: t("comments.deleteTitle"), onClick: props.onDelete, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(GwIcon, { name: "trash", size: 12 }) })
      ] })
    ] }),
...
function IssuesView({ ghRef, onCount, initialDetail, onConsumeDeep }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-colpane", style: { flex: 1, minHeight: 0, display: "flex" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "gw-open-count", children: list ? `${list.length}${total != null ? ` / ${total}` : ""} ${stateFilter === "open" ? t("issues.filterOpen") : t("issues.filterClosed")}` : "\u2026" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: { display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap", justifyContent: "flex-end" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: "created", children: t("issues.sortCreated") }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: "updated", children: t("issues.sortUpdated") })
            ]
          }
        ),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
            ...
            children: t("issues.filterClosed")
          }
        ),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-list", children: [
      ...
      list?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Empty, { children: stateFilter === "open" ? t("empty.noOpenIssues") : t("empty.noClosedIssues") }),
      ...
      nextUrl && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "gw-more", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "gw-btn", disabled: loadingMore, onClick: () => load(true, nextUrl), children: loadingMore ? t("loading") : t("loadMore") }) }),
      !nextUrl && total != null && (list?.length ?? 0) >= 1e3 && total > 1e3 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "gw-muted", style: { textAlign: "center", padding: "8px 12px 14px" }, children: t("search.limit") })
    ] }),
...
function NewIssueDrawer(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-detail", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-detail-head", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { fontWeight: 600, marginTop: 6 }, children: t("issues.newTitle") })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "gw-composer", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-composer-row", style: { justifyContent: "flex-end" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "gw-btn", onClick: props.onClose, children: t("confirm.no") }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "button",
        {
          ...
          onClick: () => {
            ...
            createIssue(props.ghRef, title.trim(), body).then((it) => {
              ui.toast(t("issues.created", { number: it.number }));
          ...
          children: busy ? t("issues.creating") : t("issues.create")
        }
      )
    ] }) })
  ] });
...
function IssueDrawer(props) {
  ...
  async function toggleState() {
    ...
    if (toClosed && !await ui.confirm({
      ...
      body: issue.title,
      confirmText: t("issues.closeText"),
      danger: true
    })) return;
    try {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "pane-wrap gw-pane-wrap", style: { position: "absolute", inset: 0, zIndex: 30, display: "flex" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-detail", style: { position: "static", flex: 1 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-detail-head", children: [
      ...
      issue ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-rowsub", style: { marginTop: 3 }, children: [
          ...
          " \xB7 ",
          issue.state === "closed" ? t("issues.closedLabel") : t("issues.open"),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
            "a",
            {
              className: "gw-link",
      ...
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "gw-muted", style: { marginTop: 8 }, children: t("loading") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-detail-body", children: [
      ...
      issue && (editing ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-composer-row", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "gw-btn primary", onClick: saveEdit, children: t("issues.saveEdit") }),
    ...
    issue && !editing && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-composer", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-composer-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: `gw-btn ${closed ? "" : "danger"}`, onClick: toggleState, children: closed ? t("issues.reopenIssue") : t("issues.closeIssue") }),
...
var FILTER_LABEL = {
  open: "pulls.filterOpen",
  closed: "pulls.filterClosed",
  merged: "pulls.filterMerged"
};
function PullsView({ ghRef, branches, visible, onCount, initialDetail, onConsumeDeep }) {
  ...
  (0, import_react5.useEffect)(() => {
    ...
    const t2 = setInterval(() => load(true), sec * 1e3);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-colpane", style: { flex: 1, minHeight: 0, display: "flex" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "gw-open-count", children: list ? `${list.length}${total != null ? ` / ${total}` : ""} ${t(FILTER_LABEL[stateFilter])}` : "\u2026" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: { display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap", justifyContent: "flex-end" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "select",
          {
            ...
            value: sort,
            onChange: (e) => setSort(e.target.value),
            title: t("issues.sortCreated"),
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "created", children: t("issues.sortCreated") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "updated", children: t("issues.sortUpdated") })
            ]
          }
        ),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-list", children: [
      ...
      list?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Empty, { children: stateFilter === "open" ? t("pulls.emptyOpen") : stateFilter === "merged" ? t("pulls.emptyMerged") : t("pulls.emptyClosed") }),
      list?.map((pr) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("button", { className: "gw-row", onClick: () => setDetail(pr.number), children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "gw-rowmain", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "gw-rowtitle", children: [
            pr.title,
            pr.draft && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "gw-chip", style: { marginLeft: 6 }, children: t("pulls.draft") })
          ] }),
      ...
      nextUrl && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "gw-more", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { className: "gw-btn", disabled: loadingMore, onClick: () => load(true, nextUrl), children: loadingMore ? t("loading") : t("loadMore") }) }),
      !nextUrl && total != null && (list?.length ?? 0) >= 1e3 && total > 1e3 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "gw-muted", style: { textAlign: "center", padding: "8px 12px 14px" }, children: t("search.limit") })
    ] }),
...
function NewPRDrawer(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { position: "absolute", inset: 0, zIndex: 30, display: "flex" }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-detail", style: { position: "static", flex: 1 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-detail-head", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { fontWeight: 600, marginTop: 6 }, children: t("pulls.newTitle") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-detail-body", style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-formrow", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-field", style: { flex: 1 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("label", { children: t("pulls.head") }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            "input",
            {
              className: "gw-input",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-field", style: { width: 140 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("label", { children: t("pulls.base") }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            "select",
            {
              className: "gw-input",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "gw-composer", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-composer-row", style: { justifyContent: "flex-end" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { className: "gw-btn", onClick: props.onClose, children: t("confirm.no") }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "button",
        {
          className: "gw-btn primary",
          ...
          onClick: () => {
            ...
            createPull(props.ghRef, { title: title.trim(), body, head: head.trim(), base }).then((pr) => {
              ui.toast(t("pulls.created", { number: pr.number }));
          ...
          children: busy ? t("issues.creating") : t("pulls.create")
        }
      )
    ] }) })
  ] }) });
...
function PullDrawer(props) {
  ...
  async function doMerge() {
    ...
    if (!await ui.confirm({
      ...
      confirmText: t(METHOD_LABEL[method]),
      danger: true
    })) return;
    setBusy(true);
    try {
  ...
  async function toggleState() {
    ...
    const toClosed = !closed;
    if (toClosed && !await ui.confirm({
      title: t("pulls.closeConfirm", { number: pull.number }),
      body: pull.title,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { position: "absolute", inset: 0, zIndex: 30, display: "flex" }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-detail", style: { position: "static", flex: 1 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-detail-head", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-rowsub", style: { marginTop: 3, flexWrap: "wrap" }, children: [
        ...
        pull.additions !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { children: [
          ...
          pull.changed_files !== void 0 ? ` \xB7 ${t("pulls.files", { count: pull.changed_files })}` : ""
        ] }),
        "\xB7 ",
        t("pulls.createdAt"),
        " ",
      ...
      canMerge && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-composer-row", style: { marginTop: 8 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "merge", children: t("pulls.mergeMethod.mergeCommit") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "squash", children: t("pulls.mergeMethod.squash") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "rebase", children: t("pulls.mergeMethod.rebase") })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        ...
        pull.mergeable === false && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "gw-muted", style: { fontSize: 10 }, children: t("pulls.mergeConflict") })
      ] }),
      checks !== null && checks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { marginTop: 8, display: "flex", flexDirection: "column", gap: 2 }, children: [
        ...
        checks.length > 8 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "gw-muted", children: t("pulls.moreChecks", { count: checks.length - 8 }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-composer", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "gw-composer-row", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { className: `gw-btn ${closed ? "" : "danger"}`, onClick: toggleState, children: closed ? t("pulls.reopen") : t("pulls.close") }) })
    ] })
  ] }) });
}
...
function ActionsView({ ghRef, visible, onCount }) {
  ...
  (0, import_react6.useEffect)(() => {
    if (!visible) return;
    const t2 = setInterval(() => setTick((n) => n + 1), 3e4);
    return () => clearInterval(t2);
  }, [visible]);
  (0, import_react6.useEffect)(() => {
    if (!visible) return;
    ...
    if (sec <= 0) return;
    const t2 = setInterval(() => reload(true), sec * 1e3);
    return () => clearInterval(t2);
  }, [visible, reload]);
  async function rerun(run) {
    try {
      await rerunRun(ghRef, run.id);
      ui.toast(t("actions.rerunSuccess", { title: run.display_title || run.name || "#" + run.id }));
  ...
  async function cancel(run) {
    if (!await ui.confirm({
      title: t("actions.cancelConfirm", { id: run.id }),
      body: `${run.display_title || run.name} \xB7 ${run.head_branch}`,
      confirmText: t("actions.cancelText"),
      danger: true
    })) return;
    try {
      await cancelRun(ghRef, run.id);
      ui.toast(t("actions.cancelSuccess"));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "gw-colpane", style: { flex: 1, minHeight: 0, display: "flex" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "gw-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "gw-open-count", children: t("actions.recent", { active: active > 0 ? t("actions.active", { count: active }) : "" }) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "gw-list", children: [
      ...
      runs?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Empty, { children: t("empty.noWorkflowRuns") }),
      runs?.map((run) => {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "gw-rowmain", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "gw-rowsub", children: [
                  ...
                  " \xB7 ",
                  run.event,
                  run.status === "completed" ? t("actions.duration", { duration: fmtDuration(Math.max(0, dur)) }) : ` \xB7 ${run.status === "queued" ? t("actions.queued") : t("actions.running")}(#${run.run_attempt})`
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "gw-hoverbar", onClick: (e) => e.stopPropagation(), children: [
                  ...
                  isActive && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { className: "gw-btn danger", onClick: () => cancel(run), children: t("actions.cancel") }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-inbox", "data-gw-inbox": "", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-inbox-bar", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "gw-open-count", children: [
        t("inbox.title"),
        unread > 0 ? t("inbox.unread", { count: unread }) : ""
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        "button",
        {
          ...
          children: t("inbox.markAllRead")
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-tabs", children: TABS.map((tabItem) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      "button",
      {
        type: "button",
        className: `gw-tab ${tab === tabItem.id ? "on" : ""}`,
        onClick: () => setTab(tabItem.id),
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: tabItem.icon, size: 13 }),
          t(tabItem.labelKey),
          snap.unreadByKind[tabItem.id] > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "gw-count", children: snap.unreadByKind[tabItem.id] })
        ]
      },
      tabItem.id
    )) }),
    snap.truncatedWatch && tab !== "actions" && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-hint", style: { padding: "6px 12px" }, children: t("inbox.descIssuesPRs") }),
    tab === "actions" && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-hint", style: { padding: "6px 12px" }, children: t("inbox.descActions") }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-list", children: [
      !snap.hasToken && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Empty, { children: t("empty.inboxNoPAT") }),
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "gw-rowmain", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "gw-rowsub", children: [
                ...
                it.repo,
                " ",
                it.kind === "actions" ? t("inbox.runNumber", { number: it.number }) : `#${it.number}`,
                " \xB7 ",
                it.user,
                " \xB7 ",
...
function InboxReturnBar(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-inbox-return", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("button", { className: "gw-btn backbtn", type: "button", onClick: props.onReturn, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "chevron-left", size: 12 }),
    t("inbox.backTo", { label: props.label })
  ] }) });
}
...
function isSubtab(v) {
  return SUBTABS.some((t2) => t2.id === v);
}
function WorkbenchApp({ sessionId, visible, seedUrl }) {
  ...
  (0, import_react8.useEffect)(() => {
    ...
    const t2 = setInterval(() => setRate(rateRemaining()), 3e3);
    return () => clearInterval(t2);
  }, [visible]);
  ...
  const ui = (0, import_react8.useMemo)(() => ({
    ...
    toast: (msg, kind = "ok") => {
      ...
      setTimeout(() => setToasts((list) => list.filter((t2) => t2.id !== id)), kind === "err" ? 6e3 : 3200);
    }
  }), []);
  (0, import_react8.useEffect)(() => {
    inboxStore.setOnFresh(visible ? (fresh) => {
      const top = fresh[0];
      if (top) {
        const kind = top.kind === "pr" ? t("inbox.kindPr") : top.kind === "actions" ? t("inbox.kindActions") : t("inbox.kindIssue");
        const id = top.kind === "actions" ? t("inbox.runNumber", { number: top.number }) : `#${top.number}`;
  ...
  const header = /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-header", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "gw-repo-name", children: repoFull || t("mount.standaloneTitle") }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "select",
      {
        className: "gw-select",
        value: effBranch,
        title: t("workbench.branchSelector"),
        onChange: (e) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-hbtn", title: t("actions.refresh"), onClick: () => setReload((n) => n + 1), children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(GwIcon, { name: "refresh", size: 14 }) }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-hbtn", title: t("workbench.settings"), onClick: () => {
      setSetPop((v) => !v);
      setRepoPop(false);
  ...
  const body = !ref ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SetupCard, { detecting, onSubmit: applyRepo, error }) : /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-tabs", children: SUBTABS.map((tabItem) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("button", { className: `gw-tab ${subtab === tabItem.id ? "on" : ""}`, onClick: () => switchTab(tabItem.id), children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(GwIcon, { name: tabItem.icon, size: 13 }),
      t(tabItem.labelKey),
      counts[tabItem.id] !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "gw-count", children: counts[tabItem.id] })
    ] }, tabItem.id)) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-footer", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("workbench.api") }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("workbench.footerStatus", {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(UICtx.Provider, { value: ui, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    "div",
    {
      ...
      children: [
        header,
        returnSnap && !inboxOpen && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(InboxReturnBar, { label: returnSnap.repoFull || t("inbox.originalRepo"), onReturn: restoreSnap }),
        ...
        toasts.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-toasts", children: toasts.map((t2) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: `gw-toast ${t2.kind}`, children: t2.msg }, t2.id)) })
      ]
    }
  ) });
}
...
function SetupCard(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-empty", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { maxWidth: 340, width: "100%" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { marginBottom: 10, lineHeight: 1.7 }, children: props.detecting ? t("loadingTree") : t("workbench.repoPrompt") }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("form", { className: "gw-formrow", onSubmit: (e) => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-btn primary", type: "submit", children: t("workbench.loadRepository") })
    ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { ref: wrap, style: { position: "absolute", inset: 0, zIndex: 50 }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop left", style: { top: 44, position: "absolute", width: "min(380px, calc(100% - 20px))" }, children: !manage ? /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("form", { className: "gw-formrow", onSubmit: (e) => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        ...
        {
          className: "gw-input",
          placeholder: props.hasToken ? t("workbench.repoFilterPlaceholder") : t("workbench.repoPrompt"),
          value,
          onChange: (e) => setValue(e.target.value),
          autoFocus: true
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-btn primary", type: "submit", children: t("workbench.switchRepository") })
    ] }),
    props.recent.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-title", style: { paddingTop: 8 }, children: t("workbench.recent") }),
      recent.map((full) => {
        const owner = full.split("/")[0];
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
          "button",
          {
            ...
            children: [
              ...
              full,
              full === props.current && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "gw-pop-cur", children: t("issues.open") }),
    ...
    props.hasToken && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-title", style: { paddingTop: 8 }, children: t("workbench.repos", { count: visibleMine.length, total: mineAll.length }) }),
      !repos && !loadErr && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: t("loading") }),
        ...
        "button",
        {
          ...
          children: [
            ...
            canDrop(r) && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
              ...
              {
                className: "gw-x",
                title: t("workbench.removeFromList"),
                onMouseDown: (e) => e.stopPropagation(),
      ...
      hidden.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-pop-hint", style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("workbench.hidden", { count: hidden.length }) }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-btn", style: { padding: "1px 8px" }, onClick: () => setManage(true), children: t("workbench.manage") })
      ] })
    ] }),
    loadErr && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-errbox", children: loadErr }),
    !props.hasToken && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: t("workbench.patHint") }),
    (q.length >= 3 || searching) && !manage && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-title", style: { paddingTop: 8 }, children: t("workbench.search", { query: q }) }),
      searching && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: t("loading") }),
      !searching && pub && pub.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: t("workbench.noResults") }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: t("workbench.pressEnter") })
    ] })
  ] }) : /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-title", children: t("workbench.hiddenRepos", { count: hidden.length }) }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { maxHeight: 240, overflow: "auto" }, children: [
      hidden.map((full) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("button", { className: "gw-pop-item", onClick: () => {
        ...
        full,
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "gw-pop-cur", children: t("workbench.restore") })
      ] }, full)),
      hidden.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", children: t("workbench.empty") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-formrow", style: { justifyContent: "flex-end", paddingTop: 6 }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-btn", onClick: () => setManage(false), children: t("issues.backToList") }) })
  ] }) }) });
}
function SettingsPopover(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { ref: wrap, style: { position: "absolute", inset: 0, zIndex: 50 }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-pop right", style: { top: 44, position: "absolute" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-title", children: t("workbench.patTitle") }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { children: t("workbench.autoRefreshOff", { label: t("mount.settingsAutoRefresh") }) }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        "input",
        {
          className: "gw-input",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { children: t("workbench.fontSize") }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
        "select",
        {
          className: "gw-input",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "dsh", children: t("workbench.followSidebar") }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "13", children: "13 px" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-pop-hint", dangerouslySetInnerHTML: { __html: t("workbench.tokenScopes") } })
  ] }) });
}
function ConfirmDialog(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "gw-scrim", onMouseDown: (e) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "gw-dialog-actions", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { className: "gw-btn", onClick: () => props.onDone(false), children: t("confirm.no") }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        "button",
        {
          ...
          children: opts.confirmText ?? t("confirm.yes")
        }
      )
    ] })
  ] }) });
...
function bindInboxBadge(registry) {
  const paint = () => {
    ...
    for (const tab of ours) {
      try {
        registry.updateTab?.(tab.id, { title });
      } catch {
      }
    }
  };
...
function mountStandalone() {
  ...
  edge.textContent = "\u{1F419} " + t("workbench.title");
  ...
  function render() {
    state.root.render((0, import_react9.createElement)(WorkbenchApp, {
      sessionId: "",
      // Standalone mode has no session context; the user enters a repository.
  ...
  const paintEdge = () => {
    const n = getInboxStore().unreadCount();
    edge.textContent = `\u{1F419} ${t("workbench.title")}${n > 0 ? t("inbox.unread", { count: n }) : ""}`;
