...
export const zh = {
  ...
  'workbench.api': 'api.github.com · REST v3',
  'workbench.footerStatus': 'core 剩余 {remaining} · {auth} · 容器 {width}px',
  ...
  'workbench.remove': '移除',
  'workbench.repos': '仓库 · {count}/{total}',
...
export const en: Record<WorkbenchKey, string> = {
  ...
  'workbench.api': 'api.github.com · REST v3',
  'workbench.footerStatus': 'core: {remaining} remaining · {auth} · pane {width}px',
  ...
  'workbench.repos': 'Repos · {count}/{total}',
